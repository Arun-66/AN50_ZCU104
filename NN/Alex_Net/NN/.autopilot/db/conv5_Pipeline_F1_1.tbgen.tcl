...
dict set ap_memory_interface_dict filter_conv5 { MEM_WIDTH 32 MEM_SIZE 1769472 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	...
	{ phi_mul183 int 18 regular  }
	{ filter_conv5 int 32 regular {array 442368 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "filter_local_8", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "phi_mul183", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
 	{ "Name" : "filter_conv5", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ phi_mul183 sc_in sc_lv 18 signal 9 } 
	{ filter_conv5_address0 sc_out sc_lv 19 signal 10 } 
	{ filter_conv5_ce0 sc_out sc_logic 1 signal 10 } 
	{ filter_conv5_q0 sc_in sc_lv 32 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "phi_mul183", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "phi_mul183", "role": "default" }} , 
 	{ "name": "filter_conv5_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "filter_conv5", "role": "address0" }} , 
 	{ "name": "filter_conv5_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "filter_conv5", "role": "ce0" }} , 
 	{ "name": "filter_conv5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "filter_conv5", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "phi_mul183", "Type" : "None", "Direction" : "I"},
			{"Name" : "filter_conv5", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	conv5_Pipeline_F1_1 {
		...
		phi_mul183 {Type I LastRead 0 FirstWrite -1}
		filter_conv5 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	phi_mul183 { ap_none {  { phi_mul183 in_data 0 18 } } }
	filter_conv5 { ap_memory {  { filter_conv5_address0 mem_address 1 19 }  { filter_conv5_ce0 mem_ce 1 1 }  { filter_conv5_q0 mem_dout 0 32 } } }
}
