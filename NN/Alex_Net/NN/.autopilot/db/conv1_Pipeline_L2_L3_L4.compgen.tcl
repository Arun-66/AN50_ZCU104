...
set name NN_mul_2ns_17ns_17_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler NN_mac_muladd_8ns_4ns_17ns_17_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler NN_mac_muladd_8ns_2ns_8ns_10_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inp_img \
    op interface \
    ports { inp_img_address0 { O 18 vector } inp_img_ce0 { O 1 bit } inp_img_q0 { I 32 vector } } \
} "
} else {
