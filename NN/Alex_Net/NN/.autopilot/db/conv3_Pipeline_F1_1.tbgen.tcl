...
dict set ap_memory_interface_dict filter_conv3 { MEM_WIDTH 32 MEM_SIZE 3538944 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	...
	{ mul_ln85 int 20 regular  }
	{ filter_conv3 int 32 regular {array 884736 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "filter_local_8", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "mul_ln85", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
 	{ "Name" : "filter_conv3", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ mul_ln85 sc_in sc_lv 20 signal 9 } 
	{ filter_conv3_address0 sc_out sc_lv 20 signal 10 } 
	{ filter_conv3_ce0 sc_out sc_logic 1 signal 10 } 
	{ filter_conv3_q0 sc_in sc_lv 32 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln85", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "mul_ln85", "role": "default" }} , 
 	{ "name": "filter_conv3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "filter_conv3", "role": "address0" }} , 
 	{ "name": "filter_conv3_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "filter_conv3", "role": "ce0" }} , 
 	{ "name": "filter_conv3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "filter_conv3", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "mul_ln85", "Type" : "None", "Direction" : "I"},
			{"Name" : "filter_conv3", "Type" : "Memory", "Direction" : "I"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	conv3_Pipeline_F1_1 {
		...
		mul_ln85 {Type I LastRead 0 FirstWrite -1}
		filter_conv3 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	mul_ln85 { ap_none {  { mul_ln85 in_data 0 20 } } }
	filter_conv3 { ap_memory {  { filter_conv3_address0 mem_address 1 20 }  { filter_conv3_ce0 mem_ce 1 1 }  { filter_conv3_q0 mem_dout 0 32 } } }
}
