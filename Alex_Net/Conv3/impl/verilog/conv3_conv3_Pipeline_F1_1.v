...
module conv3_conv3_Pipeline_F1_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [3:0] trunc_ln85_fu_267_p1;
reg   [3:0] trunc_ln85_reg_386;
reg   [3:0] trunc_ln85_reg_386_pp0_iter1_reg;
reg   [31:0] gmem1_addr_read_reg_390;
wire   [63:0] zext_ln85_fu_326_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [11:0] phi_urem6_fu_90;
wire   [11:0] select_ln85_fu_283_p3;
wire    ap_loop_init;
reg   [11:0] ap_sig_allocacmp_phi_urem6_load;
wire    ap_block_pp0_stage0;
reg   [24:0] phi_mul4_fu_94;
wire   [24:0] add_ln85_1_fu_310_p2;
reg   [11:0] h_fu_98;
wire   [11:0] add_ln85_fu_261_p2;
reg   [11:0] ap_sig_allocacmp_h_1;
reg    filter_local_7_we0_local;
wire   [31:0] bitcast_ln87_fu_339_p1;
...
wire   [0:0] icmp_ln85_1_fu_277_p2;
wire   [11:0] add_ln85_2_fu_271_p2;
wire   [8:0] tmp_fu_316_p4;
reg    ap_done_reg;
...
#0 phi_urem6_fu_90 = 12'd0;
#0 phi_mul4_fu_94 = 25'd0;
#0 h_fu_98 = 12'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln85_fu_255_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln85_fu_255_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_phi_urem6_load = 12'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd2))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd3))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd6))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd7))) begin
...
always @ (*) begin
    if ((~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd0) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd1) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd2) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd3) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd4) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd5) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd6) & ~(trunc_ln85_reg_386_pp0_iter1_reg == 4'd7) & (1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln85_reg_386_pp0_iter1_reg == 4'd0))) begin
...
assign add_ln85_1_fu_310_p2 = (phi_mul4_fu_94 + 25'd7282);

assign add_ln85_2_fu_271_p2 = (ap_sig_allocacmp_phi_urem6_load + 12'd1);

assign add_ln85_fu_261_p2 = (ap_sig_allocacmp_h_1 + 12'd1);
...
assign bitcast_ln87_fu_339_p1 = gmem1_addr_read_reg_390;

assign filter_local_1_address0 = zext_ln85_fu_326_p1;

assign filter_local_1_ce0 = filter_local_1_ce0_local;

assign filter_local_1_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_1_we0 = filter_local_1_we0_local;

assign filter_local_2_address0 = zext_ln85_fu_326_p1;

assign filter_local_2_ce0 = filter_local_2_ce0_local;

assign filter_local_2_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_2_we0 = filter_local_2_we0_local;

assign filter_local_3_address0 = zext_ln85_fu_326_p1;

assign filter_local_3_ce0 = filter_local_3_ce0_local;

assign filter_local_3_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_3_we0 = filter_local_3_we0_local;

assign filter_local_4_address0 = zext_ln85_fu_326_p1;

assign filter_local_4_ce0 = filter_local_4_ce0_local;

assign filter_local_4_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_4_we0 = filter_local_4_we0_local;

assign filter_local_5_address0 = zext_ln85_fu_326_p1;

assign filter_local_5_ce0 = filter_local_5_ce0_local;

assign filter_local_5_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_5_we0 = filter_local_5_we0_local;

assign filter_local_6_address0 = zext_ln85_fu_326_p1;

assign filter_local_6_ce0 = filter_local_6_ce0_local;

assign filter_local_6_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_6_we0 = filter_local_6_we0_local;

assign filter_local_7_address0 = zext_ln85_fu_326_p1;

assign filter_local_7_ce0 = filter_local_7_ce0_local;

assign filter_local_7_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_7_we0 = filter_local_7_we0_local;

assign filter_local_8_address0 = zext_ln85_fu_326_p1;

assign filter_local_8_ce0 = filter_local_8_ce0_local;

assign filter_local_8_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_8_we0 = filter_local_8_we0_local;

assign filter_local_address0 = zext_ln85_fu_326_p1;

assign filter_local_ce0 = filter_local_ce0_local;

assign filter_local_d0 = bitcast_ln87_fu_339_p1;

assign filter_local_we0 = filter_local_we0_local;

assign icmp_ln85_1_fu_277_p2 = ((ap_sig_allocacmp_phi_urem6_load == 12'd8) ? 1'b1 : 1'b0);

assign icmp_ln85_fu_255_p2 = ((ap_sig_allocacmp_h_1 == 12'd2304) ? 1'b1 : 1'b0);
...
assign select_ln85_fu_283_p3 = ((icmp_ln85_1_fu_277_p2[0:0] == 1'b1) ? 12'd0 : add_ln85_2_fu_271_p2);

assign tmp_fu_316_p4 = {{phi_mul4_fu_94[24:16]}};

assign trunc_ln85_fu_267_p1 = ap_sig_allocacmp_phi_urem6_load[3:0];

assign zext_ln85_fu_326_p1 = tmp_fu_316_p4;

endmodule //conv3_conv3_Pipeline_F1_1
