set moduleName norm1_Pipeline_L5_L6
set isTopModule 0
...
set cdfgNum 10
set C_modelName {norm1_Pipeline_L5_L6}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict inp_image { MEM_WIDTH 32 MEM_SIZE 2916 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict inp_image_1 { MEM_WIDTH 32 MEM_SIZE 2916 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict inp_image_2 { MEM_WIDTH 32 MEM_SIZE 2916 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict inp_image_3 { MEM_WIDTH 32 MEM_SIZE 2916 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 1}  }
	{ sext_ln74 int 62 regular  }
	{ inp_image float 32 regular {array 729 { 1 3 } 1 1 }  }
	{ inp_image_1 float 32 regular {array 729 { 1 3 } 1 1 }  }
	{ inp_image_2 float 32 regular {array 729 { 1 3 } 1 1 }  }
	{ inp_image_3 float 32 regular {array 729 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ inp_image_address0 sc_out sc_lv 10 signal 2 } 
	{ inp_image_ce0 sc_out sc_logic 1 signal 2 } 
	{ inp_image_q0 sc_in sc_lv 32 signal 2 } 
	{ inp_image_1_address0 sc_out sc_lv 10 signal 3 } 
	{ inp_image_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ inp_image_1_q0 sc_in sc_lv 32 signal 3 } 
	{ inp_image_2_address0 sc_out sc_lv 10 signal 4 } 
	{ inp_image_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ inp_image_2_q0 sc_in sc_lv 32 signal 4 } 
	{ inp_image_3_address0 sc_out sc_lv 10 signal 5 } 
	{ inp_image_3_ce0 sc_out sc_logic 1 signal 5 } 
	{ inp_image_3_q0 sc_in sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inp_image_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "inp_image", "role": "address0" }} , 
 	...
 	{ "name": "inp_image_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "inp_image_1", "role": "address0" }} , 
 	...
 	{ "name": "inp_image_2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "inp_image_2", "role": "address0" }} , 
 	...
 	{ "name": "inp_image_3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "inp_image_3", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5ns_5ns_5ns_10_4_1_U160", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	inp_image { ap_memory {  { inp_image_address0 mem_address 1 10 }  { inp_image_ce0 mem_ce 1 1 }  { inp_image_q0 mem_dout 0 32 } } }
	inp_image_1 { ap_memory {  { inp_image_1_address0 mem_address 1 10 }  { inp_image_1_ce0 mem_ce 1 1 }  { inp_image_1_q0 mem_dout 0 32 } } }
	inp_image_2 { ap_memory {  { inp_image_2_address0 mem_address 1 10 }  { inp_image_2_ce0 mem_ce 1 1 }  { inp_image_2_q0 mem_dout 0 32 } } }
	inp_image_3 { ap_memory {  { inp_image_3_address0 mem_address 1 10 }  { inp_image_3_ce0 mem_ce 1 1 }  { inp_image_3_q0 mem_dout 0 32 } } }
}
