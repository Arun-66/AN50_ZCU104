...
module norm1_pow_generic_float_s (
        ap_clk,
        ap_rst,
        base_r,
        exp,
...
norm1_mul_39ns_4ns_43_1_0 #(
    ...
    .din1_WIDTH( 4 ),
    .dout_WIDTH( 43 ))
mul_39ns_4ns_43_1_0_U108(
    .din0(mul_ln44_fu_620_p0),
    .din1(mul_ln44_fu_620_p1),
    .dout(mul_ln44_fu_620_p2)
);

(* dissolve_hierarchy = "yes" *) norm1_sparsemux_7_2_1_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 2'h2 ),
    .din0_WIDTH( 1 ),
...
norm1_bitselect_1ns_23ns_32s_1_1_0 #(
    .DATAWIDTH( 23 ),
    .ADDRWIDTH( 32 ))
bitselect_1ns_23ns_32s_1_1_0_U110(
...
norm1_mul_18ns_18ns_36_1_0 #(
    ...
    .din1_WIDTH( 18 ),
    .dout_WIDTH( 36 ))
mul_18ns_18ns_36_1_0_U112(
    .din0(mul_ln616_fu_1867_p0),
    .din1(mul_ln616_fu_1867_p1),
    .dout(mul_ln616_fu_1867_p2)
);

(* dissolve_hierarchy = "yes" *) norm1_sparsemux_19_8_32_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 8'h80 ),
    .din0_WIDTH( 32 ),
...
norm1_mac_muladd_13s_12ns_16s_25_4_0 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 25 ))
mac_muladd_13s_12ns_16s_25_4_0_U114(
    .clk(ap_clk),
    .reset(ap_rst),
...
endmodule //norm1_pow_generic_float_s
