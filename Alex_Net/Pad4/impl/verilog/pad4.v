...
reg   [3:0] j_mid2_reg_507;
reg   [3:0] j_mid2_reg_507_pp0_iter1_reg;
reg   [3:0] j_mid2_reg_507_pp0_iter2_reg;
wire   [7:0] zext_ln35_fu_239_p1;
wire   [7:0] empty_5_fu_257_p2;
reg   [7:0] empty_5_reg_518;
reg   [7:0] empty_5_reg_518_pp0_iter1_reg;
reg   [7:0] empty_5_reg_518_pp0_iter2_reg;
reg   [7:0] empty_5_reg_518_pp0_iter3_reg;
wire   [0:0] or_ln39_1_fu_287_p2;
reg   [0:0] or_ln39_1_reg_523;
reg   [0:0] or_ln39_1_reg_523_pp0_iter1_reg;
reg   [0:0] or_ln39_1_reg_523_pp0_iter2_reg;
reg   [0:0] or_ln39_1_reg_523_pp0_iter3_reg;
wire   [0:0] icmp_ln36_fu_319_p2;
reg   [0:0] icmp_ln36_reg_528;
wire   [0:0] icmp_ln35_fu_325_p2;
reg   [0:0] icmp_ln35_reg_533;
reg   [0:0] icmp_ln34_reg_538;
wire   [8:0] c_fu_363_p3;
reg   [8:0] c_reg_542;
wire   [15:0] mul_ln35_fu_394_p2;
reg   [0:0] ap_phi_mux_icmp_ln3521_phi_fu_125_p4;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [0:0] ap_phi_mux_icmp_ln3620_phi_fu_136_p4;
wire   [63:0] zext_ln45_1_fu_421_p1;
wire   [63:0] zext_ln45_fu_434_p1;
reg   [16:0] indvar_flatten1215_fu_72;
wire   [16:0] add_ln34_1_fu_313_p2;
reg   [16:0] ap_sig_allocacmp_indvar_flatten1215_load;
reg   [8:0] c16_fu_76;
...
wire   [8:0] mul_ln35_fu_394_p0;
wire   [8:0] mul_ln35_fu_394_p1;
wire   [4:0] zext_ln36_2_fu_403_p1;
wire   [4:0] add_ln45_4_fu_406_p2;
wire  signed [15:0] sext_ln45_fu_412_p1;
wire   [15:0] grp_fu_447_p3;
(* use_dsp48 = "no" *) wire   [15:0] add_ln45_1_fu_416_p2;
wire   [16:0] grp_fu_456_p3;
wire   [16:0] p_cast_fu_426_p1;
(* use_dsp48 = "no" *) wire   [16:0] add_ln45_fu_429_p2;
wire   [3:0] grp_fu_447_p0;
wire   [3:0] grp_fu_447_p1;
wire   [8:0] grp_fu_456_p0;
wire   [7:0] grp_fu_456_p1;
wire   [3:0] grp_fu_456_p2;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [16:0] grp_fu_456_p00;
wire   [16:0] grp_fu_456_p20;
wire   [15:0] mul_ln35_fu_394_p00;
...
pad4_mac_muladd_4ns_4ns_16ns_16_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 4 ),
    .din1_WIDTH( 4 ),
...
pad4_mac_muladd_9ns_8ns_4ns_17_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 9 ),
    .din1_WIDTH( 8 ),
    .din2_WIDTH( 4 ),
    .dout_WIDTH( 17 ))
mac_muladd_9ns_8ns_4ns_17_4_1_U3(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_456_p0),
    .din1(grp_fu_456_p1),
...
pad4_flow_control_loop_delay_pipe flow_control_loop_delay_pipe_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_indvar_flatten1215_load = 17'd0;
    end else begin
...
assign add_ln34_1_fu_313_p2 = (ap_sig_allocacmp_indvar_flatten1215_load + 17'd1);
...
assign add_ln45_1_fu_416_p2 = ($signed(sext_ln45_fu_412_p1) + $signed(grp_fu_447_p3));

assign add_ln45_4_fu_406_p2 = ($signed(zext_ln36_2_fu_403_p1) + $signed(5'd18));

assign add_ln45_fu_429_p2 = (grp_fu_456_p3 + p_cast_fu_426_p1);
...
always @ (*) begin
    ap_condition_404 = ((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln34_reg_538 == 1'd0));
end

always @ (*) begin
    ap_condition_411 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln34_reg_538 == 1'd0));
end
...
assign empty_5_fu_257_p2 = (p_shl_fu_249_p3 - zext_ln35_fu_239_p1);

assign empty_7_fu_439_p3 = ((or_ln39_1_reg_523_pp0_iter3_reg[0:0] == 1'b1) ? 32'd0 : inp_img_q0);
...
assign grp_fu_447_p0 = zext_ln35_fu_239_p1;

assign grp_fu_447_p1 = 8'd13;

assign grp_fu_456_p0 = grp_fu_456_p00;

assign grp_fu_456_p00 = c_fu_363_p3;

assign grp_fu_456_p1 = 17'd225;

assign grp_fu_456_p2 = grp_fu_456_p20;

assign grp_fu_456_p20 = j_mid2_reg_507_pp0_iter2_reg;

assign i_fu_225_p3 = ((and_ln34_fu_199_p2[0:0] == 1'b1) ? add_ln35_fu_205_p2 : select_ln34_fu_185_p3);

assign icmp_ln34_fu_331_p2 = ((ap_sig_allocacmp_indvar_flatten1215_load == 17'd86399) ? 1'b1 : 1'b0);
...
assign inp_img_address0 = zext_ln45_1_fu_421_p1;
...
assign mul_ln35_fu_394_p0 = mul_ln35_fu_394_p00;

assign mul_ln35_fu_394_p00 = c_reg_542;

assign mul_ln35_fu_394_p1 = 16'd169;
...
assign out_img_address0 = zext_ln45_fu_434_p1;

assign out_img_ce0 = out_img_ce0_local;

assign out_img_d0 = empty_7_fu_439_p3;

assign out_img_we0 = out_img_we0_local;

assign p_cast_fu_426_p1 = empty_5_reg_518_pp0_iter3_reg;
...
assign sext_ln45_fu_412_p1 = $signed(add_ln45_4_fu_406_p2);

assign xor_ln34_fu_193_p2 = (ap_phi_mux_icmp_ln3521_phi_fu_125_p4 ^ 1'd1);

assign zext_ln35_fu_239_p1 = i_fu_225_p3;

assign zext_ln36_2_fu_403_p1 = j_mid2_reg_507_pp0_iter2_reg;

assign zext_ln45_1_fu_421_p1 = add_ln45_1_fu_416_p2;

assign zext_ln45_fu_434_p1 = add_ln45_fu_429_p2;
