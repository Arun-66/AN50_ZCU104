...
// wrapc file define:
#define AUTOTB_TVIN_inp_img "../tv/cdatafile/c.norm2.autotvin_inp_img.dat"
#define AUTOTB_TVOUT_inp_img "../tv/cdatafile/c.norm2.autotvout_inp_img.dat"
#define AUTOTB_TVIN_out_img "../tv/cdatafile/c.norm2.autotvin_out_img.dat"
#define AUTOTB_TVOUT_out_img "../tv/cdatafile/c.norm2.autotvout_out_img.dat"
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.norm2.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.norm2.autotvout_gmem0.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.norm2.autotvout_gmem0.dat"
...
extern "C"
void norm2_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_norm2_hw(void* __xlx_apatb_param_inp_img, void* __xlx_apatb_param_out_img)
{
  ...
  port2.param = { __xlx_apatb_param_inp_img, __xlx_apatb_param_out_img };
  port2.mname = { "inp_img", "out_img" };
  port2.nbytes = { 173056, 173056 };
  for (size_t off = 0, i = 0; i < port2.nbytes.size(); ++i) {
    port2.offset.push_back(off);
    off += hls::sim::divide_ceil(port2.nbytes[i], port2.asize);
  }
  __xlx_offset_byte_param_inp_img = port2.offset[0]*4;
  __xlx_offset_byte_param_out_img = port2.offset[1]*4;
  ...
  try {
    ...
    norm2_hw_stub_wrapper(__xlx_apatb_param_inp_img, __xlx_apatb_param_out_img);
