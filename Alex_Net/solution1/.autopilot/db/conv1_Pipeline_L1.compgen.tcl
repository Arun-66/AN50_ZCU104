...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1_sparsemux_193_7_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv1_conv1_Pipeline_L1_bias_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
