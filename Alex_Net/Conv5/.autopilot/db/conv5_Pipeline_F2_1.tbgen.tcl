set moduleName conv5_Pipeline_F2_1
set isTopModule 0
...
set cdfgNum 13
set C_modelName {conv5_Pipeline_F2_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "filter","offset": { "type": "dynamic","port_name": "filter","bundle": "control"},"direction": "READONLY"},{"cName": "bias","offset": { "type": "dynamic","port_name": "bias","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln166", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln166 sc_in sc_lv 62 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln166", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln166", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1731", "Max" : "1731"}
	, {"Name" : "Interval", "Min" : "1731", "Max" : "1731"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln166 { ap_none {  { sext_ln166 in_data 0 62 } } }
