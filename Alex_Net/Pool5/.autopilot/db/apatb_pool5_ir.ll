; ModuleID = '/primary/HLS/Alex_Net/Pool5/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_pool5_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="43264" "maxi" %inp_img, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="9216" "maxi" %out_img) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([43264 x float]* nonnull %0, [43264 x float]* %inp_img_copy, [9216 x float]* nonnull %2, [9216 x float]* %out_img_copy)
  call void @apatb_pool5_hw([43264 x float]* %inp_img_copy, [9216 x float]* %out_img_copy)
  call void @copy_back([43264 x float]* %0, [43264 x float]* %inp_img_copy, [9216 x float]* %2, [9216 x float]* %out_img_copy)
...
define internal fastcc void @copy_in([43264 x float]* readonly, [43264 x float]*, [9216 x float]* readonly, [9216 x float]*) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([43264 x float]*, [43264 x float]* readonly, [9216 x float]*, [9216 x float]* readonly) unnamed_addr #4 {
entry:
...
declare void @apatb_pool5_hw([43264 x float]*, [9216 x float]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([43264 x float]*, [43264 x float]* readonly, [9216 x float]*, [9216 x float]* readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a9216f32([9216 x float]* %2, [9216 x float]* %3)
  ret void
}

declare void @pool5_hw_stub(float* noalias nocapture nonnull readonly, float* noalias nocapture nonnull)

define void @pool5_hw_stub_wrapper([43264 x float]*, [9216 x float]*) #5 {
entry:
  call void @copy_out([43264 x float]* null, [43264 x float]* %0, [9216 x float]* null, [9216 x float]* %1)
  %2 = bitcast [43264 x float]* %0 to float*
  %3 = bitcast [9216 x float]* %1 to float*
  call void @pool5_hw_stub(float* %2, float* %3)
  call void @copy_in([43264 x float]* null, [43264 x float]* %0, [9216 x float]* null, [9216 x float]* %1)
  ret void
}
