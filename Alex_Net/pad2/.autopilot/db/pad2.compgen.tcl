...
set name pad2_mul_9ns_9ns_16_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pad2_mac_muladd_4ns_4ns_16ns_16_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pad2_mac_muladd_9ns_8ns_4ns_16_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
set InstName pad2_flow_control_loop_delay_pipe_U
set CompName pad2_flow_control_loop_delay_pipe
