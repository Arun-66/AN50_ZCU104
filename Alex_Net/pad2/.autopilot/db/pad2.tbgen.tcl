...
dict set ap_memory_interface_dict out_img { MEM_WIDTH 32 MEM_SIZE 230400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ inp_img int 32 regular {array 43264 { 1 3 } 1 1 }  }
	{ out_img int 32 regular {array 57600 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_9ns_8ns_4ns_16_4_1_U3", "Parent" : "0"},
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "57606", "Max" : "57606"}
]}
